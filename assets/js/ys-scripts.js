...
if (document.querySelector('body.page-about')) {
    ...
    const founders_skewed_container_row = document.querySelector('.skewed-row');
    const founders_skewed_image_container = document.querySelector('.skewed-img-container');
    const founders_skewed_image = document.querySelector('.skewed-img-container img');
